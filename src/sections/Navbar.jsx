...
const Navbar = () => {
    ...
    return (
        ...
        <div className="">
            <div className="navbar px-10 py-5 max-w-[90%] mx-auto bg-[#FFFFFF] rounded-[2rem]">
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal font-semibold gap-7 text-base px-1">
                        {navLinks}
                    </ul>
                </div>
